...
const (
	...
	ExecType_TypeTiCIScan           ExecType = 17
)
...
type TiCIScanQueryType int32

const (
	TiCIScanQueryType_QueryMatch TiCIScanQueryType = 0
	TiCIScanQueryType_QueryRank  TiCIScanQueryType = 1
)

var TiCIScanQueryType_name = map[int32]string{
	0: "QueryMatch",
	1: "QueryRank",
}

var TiCIScanQueryType_value = map[string]int32{
	"QueryMatch": 0,
	"QueryRank":  1,
}

func (x TiCIScanQueryType) Enum() *TiCIScanQueryType {
	p := new(TiCIScanQueryType)
	*p = x
	return p
}

func (x TiCIScanQueryType) String() string {
	return proto.EnumName(TiCIScanQueryType_name, int32(x))
}

func (x *TiCIScanQueryType) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(TiCIScanQueryType_value, data, "TiCIScanQueryType")
	if err != nil {
		return err
	}
	*x = TiCIScanQueryType(value)
	return nil
}

func (TiCIScanQueryType) EnumDescriptor() ([]byte, []int) {
...
type Executor struct {
	...
	TiciScan                      *TiCIScan           `protobuf:"bytes,21,opt,name=tici_scan,json=ticiScan" json:"tici_scan,omitempty"`
}
...
func (m *Executor) GetTiciScan() *TiCIScan {
	if m != nil {
		return m.TiciScan
	}
	return nil
...
type TiCIScan struct {
	TableId       int64              `protobuf:"varint,1,opt,name=table_id,json=tableId" json:"table_id"`
	IndexId       int64              `protobuf:"varint,2,opt,name=index_id,json=indexId" json:"index_id"`
	ReturnColumns []*ColumnInfo      `protobuf:"bytes,3,rep,name=return_columns,json=returnColumns" json:"return_columns,omitempty"`
	QueryColumns  []*ColumnInfo      `protobuf:"bytes,4,rep,name=query_columns,json=queryColumns" json:"query_columns,omitempty"`
	Type          *TiCIScanQueryType `protobuf:"varint,5,opt,name=type,enum=tipb.TiCIScanQueryType" json:"type,omitempty"`
	QueryJsonStr  *string            `protobuf:"bytes,6,opt,name=query_json_str,json=queryJsonStr" json:"query_json_str,omitempty"`
	Limit         uint64             `protobuf:"varint,7,opt,name=limit" json:"limit"`
}

func (m *TiCIScan) Reset()         { *m = TiCIScan{} }
func (m *TiCIScan) String() string { return proto.CompactTextString(m) }
func (*TiCIScan) ProtoMessage()    {}
func (*TiCIScan) Descriptor() ([]byte, []int) {
	return fileDescriptor_12d1cdcda51e000f, []int{34}
}
func (m *TiCIScan) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TiCIScan) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TiCIScan.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TiCIScan) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TiCIScan.Merge(m, src)
}
func (m *TiCIScan) XXX_Size() int {
	return m.Size()
}
func (m *TiCIScan) XXX_DiscardUnknown() {
	xxx_messageInfo_TiCIScan.DiscardUnknown(m)
}

var xxx_messageInfo_TiCIScan proto.InternalMessageInfo

func (m *TiCIScan) GetTableId() int64 {
	if m != nil {
		return m.TableId
	}
	return 0
...
func (m *TiCIScan) GetIndexId() int64 {
	if m != nil {
		return m.IndexId
	}
	return 0
...
func (m *TiCIScan) GetReturnColumns() []*ColumnInfo {
	if m != nil {
		return m.ReturnColumns
	}
	return nil
}

func (m *TiCIScan) GetQueryColumns() []*ColumnInfo {
	if m != nil {
...
func (m *TiCIScan) GetType() TiCIScanQueryType {
	if m != nil && m.Type != nil {
		return *m.Type
	}
	return TiCIScanQueryType_QueryMatch
}

func (m *TiCIScan) GetQueryJsonStr() string {
	if m != nil && m.QueryJsonStr != nil {
		return *m.QueryJsonStr
	}
	return ""
}

func (m *TiCIScan) GetLimit() uint64 {
	if m != nil {
		return m.Limit
	}
	return 0
...
func init() {
	...
	proto.RegisterEnum("tipb.TiCIScanQueryType", TiCIScanQueryType_name, TiCIScanQueryType_value)
	...
	proto.RegisterType((*TiCIScan)(nil), "tipb.TiCIScan")
}
...
var fileDescriptor_12d1cdcda51e000f = []byte{
	...
	,
}
...
func (m *Executor) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.TiciScan != nil {
		{
			size, err := m.TiciScan.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *TiCIScan) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TiCIScan) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TiCIScan) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	i--
	dAtA[i] = 0x38
	if m.QueryJsonStr != nil {
		i -= len(*m.QueryJsonStr)
		copy(dAtA[i:], *m.QueryJsonStr)
		i = encodeVarintExecutor(dAtA, i, uint64(len(*m.QueryJsonStr)))
		i--
		dAtA[i] = 0x32
	}
	if m.Type != nil {
	...
	if len(m.QueryColumns) > 0 {
		for iNdEx := len(m.QueryColumns) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.QueryColumns[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.ReturnColumns) > 0 {
		for iNdEx := len(m.ReturnColumns) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ReturnColumns[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *TiCIScan) Size() (n int) {
	...
	n += 1 + sovExecutor(uint64(m.IndexId))
	if len(m.ReturnColumns) > 0 {
		for _, e := range m.ReturnColumns {
			l = e.Size()
			n += 1 + l + sovExecutor(uint64(l))
		}
	}
	if len(m.QueryColumns) > 0 {
		for _, e := range m.QueryColumns {
			l = e.Size()
			n += 1 + l + sovExecutor(uint64(l))
		}
	}
...
func (m *Executor) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 21:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TiciScan", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.TiciScan.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *TiCIScan) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TiCIScan: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TiCIScan: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReturnColumns", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ReturnColumns = append(m.ReturnColumns, &ColumnInfo{})
			if err := m.ReturnColumns[len(m.ReturnColumns)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field QueryColumns", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.QueryColumns = append(m.QueryColumns, &ColumnInfo{})
			if err := m.QueryColumns[len(m.QueryColumns)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				v |= TiCIScanQueryType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field QueryJsonStr", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
