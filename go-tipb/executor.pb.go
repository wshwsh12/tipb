...
type TableScan struct {
	...
	Bloom            *BloomFilter  `protobuf:"bytes,4,opt,name=bloom" json:"bloom,omitempty"`
	XXX_unrecognized []byte        `json:"-"`
}
...
func (m *TableScan) GetBloom() *BloomFilter {
	if m != nil {
		return m.Bloom
	}
	return nil
...
func (m *TableScan) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Bloom != nil {
		dAtA[i] = 0x22
		i++
		i = encodeVarintExecutor(dAtA, i, uint64(m.Bloom.Size()))
		n8, err := m.Bloom.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n8
...
var fileDescriptorExecutor = []byte{
	...
	,
}
