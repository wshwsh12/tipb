...
type Selection struct {
	...
	// Bloom
	Bloom            []*BloomFilter `protobuf:"bytes,3,rep,name=bloom" json:"bloom,omitempty"`
	XXX_unrecognized []byte         `json:"-"`
}
...
func (m *Selection) GetBloom() []*BloomFilter {
	if m != nil {
		return m.Bloom
	}
	return nil
...
type BloomFilter struct {
	...
	BitSet []uint64 `protobuf:"fixed64,1,rep,name=bit_set,json=bitSet" json:"bit_set,omitempty"`
	// Column indices of join keys
	ColIdx           []int64 `protobuf:"varint,2,rep,name=col_idx,json=colIdx" json:"col_idx,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}
...
func (*BloomFilter) Descriptor() ([]byte, []int) { return fileDescriptorExecutor, []int{9} }
...
func (m *BloomFilter) GetColIdx() []int64 {
	if m != nil {
		return m.ColIdx
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*BloomFilter)(nil), "tipb.BloomFilter")
...
func (m *Selection) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Bloom = append(m.Bloom, &BloomFilter{})
			if err := m.Bloom[len(m.Bloom)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorExecutor = []byte{
	...
	,
}
