...
type ChunkMemoryLayout struct {
	// Represents the tidb system endian
	TidbSystemEndian Endian `protobuf:"varint,1,opt,name=tidb_system_endian,json=tidbSystemEndian,enum=tipb.Endian" json:"tidb_system_endian"`
	XXX_unrecognized []byte `json:"-"`
}
...
func (m *ChunkMemoryLayout) GetTidbSystemEndian() Endian {
	if m != nil {
		return m.TidbSystemEndian
	}
...
func (m *ChunkMemoryLayout) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x8
	i++
	i = encodeVarintSelect(dAtA, i, uint64(m.TidbSystemEndian))
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
	return i, nil
...
func (m *ChunkMemoryLayout) Size() (n int) {
	var l int
	_ = l
	n += 1 + sovSelect(uint64(m.TidbSystemEndian))
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
	return n
...
func (m *ChunkMemoryLayout) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TidbSystemEndian", wireType)
			}
			m.TidbSystemEndian = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowSelect
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TidbSystemEndian |= (Endian(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorSelect = []byte{
	...
	,
}
